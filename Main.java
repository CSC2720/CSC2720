...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		layout2.getChildren().add(ReturnButton1);
		...
		Submit1.setOnAction(e -> {
			if (SSNValidityCheck(SSNField)&&PhoneValidityCheck(PhoneField)&&notNull(LastNameField,FirstNameField,TitleField,SSNField)&&doesThatJobExist(TitleField)) {
	...
	public boolean doesThatJobExist(TextField j) {
		...
		AlertBox.display("Error","INVALID!!! That Job Does Not Exist");
		return false;
	}
